...
public class Doc_JPRecognition extends Doc
{
	...
	{
		super (as, MRecognition.class, rs, DOCTYPE_PurchaseRequisition, trxName);
	}
	...
	protected String loadDocumentDetails ()
	{
		...
		setDateDoc (recognition.getDateAcct());
		setDateAcct (recognition.getDateAcct());
		// Amounts
		setAmount(AMTTYPE_Gross, recognition.getGrandTotal());
		setAmount(AMTTYPE_Net, recognition.getGrandTotal());
