 ...
 */
public final class DocTaxJournal
{
	/**
	 *	Create Tax
	 *  @param C_Tax_ID tax
	 ...
	 */
	public DocTaxJournal (int C_Tax_ID, String name, BigDecimal rate, 
		BigDecimal taxBaseAmt, BigDecimal amount, boolean salesTax, int AD_Org_ID)
	{
		m_C_Tax_ID = C_Tax_ID;
		m_name = name;
		m_rate = rate;
	...
	/**	Logger			*/
	private static final CLogger log = CLogger.getCLogger(DocTaxJournal.class);
