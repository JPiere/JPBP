...
public class X_JP_InvValCal extends PO implements I_JP_InvValCal, I_Persistent 
{
...
// N
    ...
    /** Load Constructor */
    public X_JP_InvValCal (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_JP_InvValCal[")
	...
	{
		set_ValueNoCheck (COLUMNNAME_DateValue, DateValue);
	}
	...
	/** Set Inventory Valuation Calculate Doc.
		@param JP_InvValCal_UU Inventory Valuation Calculate Doc	  */
	public void setJP_InvValCal_UU (String JP_InvValCal_UU)
	{
		set_ValueNoCheck (COLUMNNAME_JP_InvValCal_UU, JP_InvValCal_UU);
	}

	/** Get Inventory Valuation Calculate Doc.
		@return Inventory Valuation Calculate Doc	  */
	public String getJP_InvValCal_UU () 
	{
		return (String)get_Value(COLUMNNAME_JP_InvValCal_UU);
	}
	...
	/** Set Last Date Value.
		@param JP_LastDateValue Last Date Value	  */
	public void setJP_LastDateValue (Timestamp JP_LastDateValue)
	{
		set_Value (COLUMNNAME_JP_LastDateValue, JP_LastDateValue);
	}

	/** Get Last Date Value.
		@return Last Date Value	  */
	public Timestamp getJP_LastDateValue () 
	{
		return (Timestamp)get_Value(COLUMNNAME_JP_LastDateValue);
	}
