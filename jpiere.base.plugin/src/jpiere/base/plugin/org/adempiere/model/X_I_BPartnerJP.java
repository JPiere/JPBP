...
// N
    ...
    {
      StringBuffer sb = new StringBuffer ("X_I_BPartnerJP[")
    ...
    {
		return (I_JP_BillSchema)MTable.get(getCtx(), I_JP_BillSchema.Table_Name)
	...
	/** Set Invoice Print Format(Name).
		@param JP_Invoice_PrintFormat_Name 
		Print Format for printing Invoices
	  */
