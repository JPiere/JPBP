...
@org.adempiere.base.Model(table="JP_ContractLine")
...
// 1
    ...
    /** Standard Constructor */
    public X_JP_ContractLine (Properties ctx, int JP_ContractLine_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, JP_ContractLine_ID, trxName, virtualColumns);
      /** if (JP_ContractLine_ID == 0)
        {
			setC_Tax_ID (0);
			setC_UOM_ID (0);
...
// 1
	...
	*/
	...
	{
		return (I_JP_ContractLineT)MTable.get(getCtx(), I_JP_ContractLineT.Table_ID)
