...
@org.adempiere.base.Model(table="JP_ContractPSInOutLine")
...
// @SQL=SELECT Line AS DefaultValue FROM JP_ContractPSLine WHERE JP_ContractPSLine_ID=@JP_ContractPSLine_ID@
    ...
    /** Standard Constructor */
    public X_JP_ContractPSInOutLine (Properties ctx, int JP_ContractPSInOutLine_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, JP_ContractPSInOutLine_ID, trxName, virtualColumns);
      /** if (JP_ContractPSInOutLine_ID == 0)
        {
			setC_Tax_ID (0);
			setC_UOM_ID (0);
