...
/** Generated Model for I_OrderJP
 *  @author iDempiere (generated) 
 *  @version Release 5.1 - $Id$ */
public class X_I_OrderJP extends PO implements I_I_OrderJP, I_Persistent 
{
    ...
    {
      super (ctx, I_OrderJP_ID, trxName);
      /** if (I_OrderJP_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_I_OrderJP (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_I_OrderJP[")
	...
	/** Set JPiere Import Order.
		@param I_OrderJP_ID JPiere Import Order	  */
	public void setI_OrderJP_ID (int I_OrderJP_ID)
	{
		if (I_OrderJP_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_I_OrderJP_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_I_OrderJP_ID, Integer.valueOf(I_OrderJP_ID));
	}

	/** Get JPiere Import Order.
		@return JPiere Import Order	  */
	public int getI_OrderJP_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_I_OrderJP_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set I_OrderJP_UU.
		@param I_OrderJP_UU I_OrderJP_UU	  */
	public void setI_OrderJP_UU (String I_OrderJP_UU)
	{
		set_Value (COLUMNNAME_I_OrderJP_UU, I_OrderJP_UU);
	}

	/** Get I_OrderJP_UU.
		@return I_OrderJP_UU	  */
	public String getI_OrderJP_UU () 
	{
