...
@org.adempiere.base.Model(table="JP_Estimation")
...
// @IsSOTrx@
			...
			setJP_EstimationDate (new Timestamp( System.currentTimeMillis() ));
// @#Date@
...
// 1
    ...
    /** Standard Constructor */
    public X_JP_Estimation (Properties ctx, int JP_Estimation_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, JP_Estimation_ID, trxName, virtualColumns);
      /** if (JP_Estimation_ID == 0)
        {
			setC_Currency_ID (0);
// @C_Currency_ID@
...
// 1
    ...
    /** Load Constructor */
    public X_JP_Estimation (Properties ctx, ResultSet rs, String trxName)
    {
	...
	*/
	...
	/** Set JP_Estimation_UU.
		@param JP_Estimation_UU JP_Estimation_UU
	*/
	public void setJP_Estimation_UU (String JP_Estimation_UU)
	{
		set_Value (COLUMNNAME_JP_Estimation_UU, JP_Estimation_UU);
	}

	/** Get JP_Estimation_UU.
		@return JP_Estimation_UU	  */
