...
public class X_I_GLJournalJP extends PO implements I_I_GLJournalJP, I_Persistent 
{
	 ...
	 *
	 */
	private static final long serialVersionUID = 20180709L;
    ...
    {
      StringBuffer sb = new StringBuffer ("X_I_GLJournalJP[")
	...
	/** Set User Column 1(Search key).
		@param JP_UserElement1_Value User Column 1(Search key)	  */
	...
	/** Get User Column 1(Search key).
		@return User Column 1(Search key)	  */
	...
	/** Set User Column 2(Search key).
		@param JP_UserElement2_Value User Column 2(Search key)	  */
	...
	/** Get User Column 2(Search key).
		@return User Column 2(Search key)	  */
