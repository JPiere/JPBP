...
/** Generated Model for JP_GLJournalTax
 *  @author iDempiere (generated) 
 *  @version Release 9 - $Id$ */
@org.adempiere.base.Model(table="JP_GLJournalTax")
public class X_JP_GLJournalTax extends PO implements I_JP_GLJournalTax, I_Persistent 
{

	/**
	 *
	 */
	private static final long serialVersionUID = 20220319L;

    /** Standard Constructor */
    public X_JP_GLJournalTax (Properties ctx, int JP_GLJournalTax_ID, String trxName)
    {
      super (ctx, JP_GLJournalTax_ID, trxName);
      /** if (JP_GLJournalTax_ID == 0)
        {
			setC_Tax_ID (0);
			setGL_Journal_ID (0);
    ...
    /** Standard Constructor */
    public X_JP_GLJournalTax (Properties ctx, int JP_GLJournalTax_ID, String trxName, String ... virtualColumns)
    {
    ...
    /** Load Constructor */
    public X_JP_GLJournalTax (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_JP_GLJournalTax[")
	...
	*/
	...
	/** Set JP_GLJournalTax_UU.
		@param JP_GLJournalTax_UU JP_GLJournalTax_UU
	*/
	public void setJP_GLJournalTax_UU (String JP_GLJournalTax_UU)
	{
		set_Value (COLUMNNAME_JP_GLJournalTax_UU, JP_GLJournalTax_UU);
	}

	/** Get JP_GLJournalTax_UU.
		@return JP_GLJournalTax_UU	  */
	public String getJP_GLJournalTax_UU()
	{
		return (String)get_Value(COLUMNNAME_JP_GLJournalTax_UU);
	}
