...
/** Generated Interface for I_UserJP
 *  @author iDempiere (generated) 
 *  @version Release 5.1
 */
@SuppressWarnings("all")
public interface I_I_UserJP 
{

    /** TableName=I_UserJP */
    public static final String Table_Name = "I_UserJP";
    ...
    /** Column name I_UserJP_ID */
    public static final String COLUMNNAME_I_UserJP_ID = "I_UserJP_ID";
    ...
    /** Column name I_UserJP_UU */
    public static final String COLUMNNAME_I_UserJP_UU = "I_UserJP_UU";
    ...
    /** Column name JP_BP_Location_Label */
    public static final String COLUMNNAME_JP_BP_Location_Label = "JP_BP_Location_Label";
    ...
    /** Column name JP_Corporation_Value */
    public static final String COLUMNNAME_JP_Corporation_Value = "JP_Corporation_Value";
    ...
    /** Column name JP_Job_Name */
    public static final String COLUMNNAME_JP_Job_Name = "JP_Job_Name";
    ...
    /** Column name JP_Supervisor_EMail */
    public static final String COLUMNNAME_JP_Supervisor_EMail = "JP_Supervisor_EMail";
