...
@org.adempiere.base.Model(table="JP_ContractContentT")
...
// 5
    ...
    /** Standard Constructor */
    public X_JP_ContractContentT (Properties ctx, int JP_ContractContentT_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, JP_ContractContentT_ID, trxName, virtualColumns);
      /** if (JP_ContractContentT_ID == 0)
        {
			setC_Currency_ID (0);
// @C_Currency_ID@
...
// 5
	...
	*/
	...
	/** Set Contract Calendar Reference.
		@param JP_ContractCalenderRef_ID Contract Calendar Reference
	*/
	...
	/** Get Contract Calendar Reference.
		@return Contract Calendar Reference	  */
