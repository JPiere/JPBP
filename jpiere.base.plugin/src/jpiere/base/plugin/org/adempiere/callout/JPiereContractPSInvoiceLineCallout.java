		...
		if(mField.getColumnName().equals("JP_ContractPSLine_ID"))
		{
			...
			if( value != null)
			{
				...
				for(int i = 0 ; i < fields.length; i++)
				{
					...
					if(columnIndex > -1)
					{
						...
						if(columnName.equals("QtyEntered"))
						{
							...
							mTab.setValue("QtyInvoiced", objectValue);
				...
				if(obj_ContractLine_ID != null)
				{
					...
					mTab.setValue("JP_ContractCalender_Inv_ID", contractLine.getJP_ContractCalender_Inv_ID());
					mTab.setValue("JP_ContractProcess_Inv_ID", contractLine.getJP_ContractProcess_Inv_ID());
				}
