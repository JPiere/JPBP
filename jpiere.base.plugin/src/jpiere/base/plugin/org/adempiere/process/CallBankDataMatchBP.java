...
/**
 * JPIERE-00302 : Bank Data match Business Partner
 *
 *
 *  @author Hideaki Hagiwara
 *
 */
public class CallBankDataMatchBP extends SvrProcess {
	...
	protected String doIt() throws Exception
	{
		...
		if(isOK)
		{
			m_BankData.setJP_Processing2("Y");
			m_BankData.setJP_ProcessedTime2(new Timestamp(System.currentTimeMillis()));
