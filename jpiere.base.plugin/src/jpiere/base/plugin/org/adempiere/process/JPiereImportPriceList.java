...
/**
 *  JPIERE-0410: Import Price Lists from I_PriceList
 *
 * 	@author 	Carlos Ruiz
 *  @Modification 	Hideaki Hagiwara
 */
public class JPiereImportPriceList extends SvrProcess
{
	...
	protected String doIt() throws Exception
	{
		...
		String msg = Msg.getMsg(getCtx(), "Matching");
		...
		*/
		...
		try
		{
			...
			{
				i++;
				if (processMonitor != null)	processMonitor.statusUpdate(Integer.toString(i));
