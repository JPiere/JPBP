...
public class CallInvValAdjustCalClass extends SvrProcess {
	...
	protected String doIt() throws Exception
	{
		...
		if(Util.isEmpty(m_InvValProfile.getJP_InvValAdjustCalClass()))
		{
			className = "jpiere.base.plugin.org.adempiere.process.DefaultInvValAdjustCalculate";

		}else{
			className = m_InvValProfile.getJP_InvValAdjustCalClass();
		}
