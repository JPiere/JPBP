 ...
 *
 */
public class CallBankDataCreateDoc extends SvrProcess {
	...
	protected String doIt() throws Exception
	{
		...
		if(isOK)
		{
			m_BankData.setJP_Processing7("Y");
			m_BankData.setJP_ProcessedTime7(new Timestamp(System.currentTimeMillis()));
