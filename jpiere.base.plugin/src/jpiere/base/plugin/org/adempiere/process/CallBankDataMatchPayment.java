...
/**
 * JPIERE-00302 : Bank Data match Payment
 *
 *
 *  @author Hideaki Hagiwara
 *
 */
public class CallBankDataMatchPayment extends SvrProcess {
	...
	protected String doIt() throws Exception
	{
		...
		if(Util.isEmpty(m_BankDataSchema.getJP_BankDataMatchPaymentClass()))
			pi.setClassName("jpiere.base.plugin.org.adempiere.process.DefaultBankDataMatchPayment");
		else
			pi.setClassName(m_BankDataSchema.getJP_BankDataMatchPaymentClass());
		...
		if(isOK)
		{
			m_BankData.setJP_Processing5("Y");
			m_BankData.setJP_ProcessedTime5(new Timestamp(System.currentTimeMillis()));
