 ...
 *
 */
public class JPiereBasePluginProcessFactory implements IProcessFactory {

	private final static CLogger log = CLogger.getCLogger(JPiereBasePluginProcessFactory.class);

	/**
	 * default constructor
	 */
	public JPiereBasePluginProcessFactory() {
	}
